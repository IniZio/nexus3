...
//
// Derived from github.com/clawkwork/clawk internal/netfilter/blocks.go.
...
// to the next mechanism — runtime grants, or the default fail-closed refusal.
type Verdict int
...
type Block struct {
	...
	// guardrail — at resolution time it cannot be overridden by a runtime
	// grant, only by a higher block.
	DenyDomains []string
