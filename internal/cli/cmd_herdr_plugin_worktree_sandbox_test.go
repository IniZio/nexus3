...
func noopCreate(_ context.Context, _, _, _, _ string, _ []string, _ []string, _ string) error {
	return nil
}

// errCreate is a createSandbox stub that always fails.
func errCreate(_ context.Context, _, _, _, _ string, _ []string, _ []string, _ string) error {
...
func TestHerdrWorktreeSandbox_alreadyBound_noOp(t *testing.T) {
	...
	err := callHerdrWorktreeSandbox(t, "w-already", root, false, false, /*auto*/
		func(_ context.Context, _, _, _, _ string, _ []string, _ []string, _ string) error { createCalled = true; return nil },
		nil,
	)
	if err != nil {
...
func TestHerdrWorktreeSandbox_conditional_sourceBound_binds(t *testing.T) {
	...
	err := callHerdrWorktreeSandbox(t, "w-new", root, true, false, /*auto*/
		func(_ context.Context, handle, mountSpec, _, _ string, _ []string, _ []string, _ string) error {
			gotHandle = handle
			gotMount = mountSpec
			return nil
		},
...
func TestHerdrWorktreeSandbox_createArgs(t *testing.T) {
	...
	_ = callHerdrWorktreeSandbox(t, "w-c", root, false, false, /*auto*/
		func(_ context.Context, h, m, _, _ string, _ []string, _ []string, _ string) error {
			gotHandle = h
			gotMount = m
			return nil
		},
...
func TestHerdrWorktreeSandboxCreateArgs_dockerDiskOnFileBuild(t *testing.T) {
	fileArgs := herdrWorktreeSandboxCreateArgs("hanlun-lms/HAN-871", "/wt:/workspace", "--file", "/wt", nil, nil, "")
	...
	imgArgs := herdrWorktreeSandboxCreateArgs("hanlun-lms/HAN-871", "/wt:/workspace", "--image", herdrDefaultImage, nil, nil, "")
...
func TestHerdrWorktreeSandboxCreateArgs_containsNoBuiltinGh(t *testing.T) {
	...
	args := herdrWorktreeSandboxCreateArgs("myrepo/my-branch", "/repo:/workspace", "--image", herdrDefaultImage, nil, nil, "")
	for _, a := range args {
		if a == "--no-builtin-gh" {
...
func TestHerdrWorktreeSandboxCreateArgs_isBootableShaped(t *testing.T) {
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			args := herdrWorktreeSandboxCreateArgs("myrepo/branch", "/repo:/workspace", tc.imageFlag, tc.imageVal, nil, nil, "")
...
func TestHerdrWorktreeSandbox_explicitMode_createError_returnsError(t *testing.T) {
	...
	err := callHerdrWorktreeSandbox(t, "w-exp", root, false, false, /*auto*/
		func(_ context.Context, _, _, _, _ string, _ []string, _ []string, _ string) error { return createErr },
		nil,
	)
	if err == nil {
...
func TestHerdrWorktreeSandbox_conditionalMode_createError_returnsNil(t *testing.T) {
	...
	err := callHerdrWorktreeSandbox(t, "w-cond", root, true, false, /*auto*/
		func(_ context.Context, _, _, _, _ string, _ []string, _ []string, _ string) error { return errors.New("create failed") },
		nil,
	)
	if err != nil {
...
func TestHerdrWorktreeSandbox_auto_concurrent_secondIsNoOp(t *testing.T) {
	...
	err = callHerdrWorktreeSandbox(t, "w-new", root, false, true, /*auto*/
		func(_ context.Context, _, _, _, _ string, _ []string, _ []string, _ string) error { createCalledSecond = true; return nil },
		nil)
	if err != nil {
...
func TestHerdrWorktreeSandboxCreateArgs_extraMountsAddedAfterPrimary(t *testing.T) {
	...
	args := herdrWorktreeSandboxCreateArgs("myrepo/branch", "/checkout:/workspace", "--image", "base", extra, nil, "")
...
func TestHerdrWorktreeSandbox_linkedWorktree_gitDirMountPassedToCreate(t *testing.T) {
	...
	err := callHerdrWorktreeSandbox(t, "w-gitproof", root, false, false, /*auto*/
		func(_ context.Context, _, _, _, _ string, extraMounts []string, _ []string, _ string) error {
